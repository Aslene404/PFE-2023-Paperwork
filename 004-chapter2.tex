...
\multicolumn{1}{|l|}{Normal scenario}            & \begin{tabular}[c]{@{}l@{}}1. User accesses the dashboard interface\\ 2. Multiple KPI charts pops up \\ 3. User may click a bar from the developers' Error Metrics Chart\\ to access error logs specific to the selected developer \end{tabular}       \\ \hline
